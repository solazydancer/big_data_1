...
outFileName = 'access_log_'+timestr+'.log' if not file_prefix else file_prefix+'access_log_'+timestr+'.log'
...
while (flag):
	...
	ip = numpy.random.choice(ip4,p=[0.6,0.1,0.1,0.1,0.1])
	...
	referer = faker.uri()
	useragent = numpy.random.choice(ualist, p=[0.25,0.25,0.2,0.1,0.2])()
